...
export async function DELETE(request: NextRequest) {
  ...
  if (
    ...
    return NextResponse.json(
      {
        message:
          'Não é possível deletar o usuário pois existe(m) chamado(s) associado(s) a ele. Mas o mesmo foi desativado.',
      },
      { status: 400 },
    )
  }
