...
import { ClientTicketsList } from '@/components/tickets-datatable/get-tickets-client'
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbList,
...
export const metadata = {
  title: 'Painel de Controle :: Colaborador - TechSupport',
  description: 'Painel de controle do colaborador',
}
