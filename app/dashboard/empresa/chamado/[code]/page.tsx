...
export const metadata = {
  title: 'Detalhes do Chamado :: Administrador da Empresa - TechSupport',
  description: 'Detalhes do chamado do administrador de empresa',
}

export default function ClientAdminTicketDetailsPage() {
  return (
    <ClientAdminTemplate>
      <SidebarInset>
