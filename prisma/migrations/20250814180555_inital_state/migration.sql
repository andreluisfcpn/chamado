...
CREATE TABLE "public"."Card" (
    ...
    "website" TEXT,
    "bio" TEXT,
    "frontColor" TEXT NOT NULL DEFAULT '#ffffff',
    "backColor" TEXT NOT NULL DEFAULT '#ffffff',
...
-- AddForeignKey
ALTER TABLE "public"."Card" ADD CONSTRAINT "Card_templateId_fkey" FOREIGN KEY ("templateId") REFERENCES "public"."Template"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
